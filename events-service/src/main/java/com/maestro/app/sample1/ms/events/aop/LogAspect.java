package com.maestro.app.sample1.ms.events.aop;
...
public class LogAspect {
	...
	public Object LogExecution(ProceedingJoinPoint joinPoint, LogExecution logExecution) throws Throwable {
		...
		Object result = null;
		LoggerFactory.getLogger(className).debug(" ** Will execute method {}:{}.", className, methodName);
		...
		try {
			...
			LoggerFactory.getLogger(className).debug("Method {} executed within {}:{} miliseconds.", className, methodName, stopWatch.getTotalTimeMillis());
		} catch (Exception ex) {
	...
	public Object LogRequest(ProceedingJoinPoint joinPoint, LogRequest logRequest) throws Throwable {
		...
		// Logs info
		logger.debug(" Access for method {}:{}, [{}][{}][{}][{}][{}]",
